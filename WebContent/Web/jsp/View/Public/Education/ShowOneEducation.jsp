...
<html>
	<head>
<% 
	Education c=(Education)request.getAttribute("education");
	...
	<body>
		...
		<div id="section" class="wrapper">
			...
			<%-- 		<li><a href="/GDUTHackerSpace/Web/jsp/View/Public/Education/AboutCourse.jsp">课程体系</a></li>
					<li <%=c.getTag()==0?"class='current'":""%>><a href="showPublishedEducation?tag=0">讲座论坛</a></li>
					<li <%=c.getTag()==1?"class='current'":""%>><a href="showPublishedEducation?tag=1">实践实训</a></li> --%>
				</ul>
			...
			<div id="new_article">
				<h1>标题<%=c.getTitle() %></h1>
				<h3>
					<span class="temp_mess">编辑者：<%=c.getAuthorName() %></span>
					<span class="temp_mess">编辑时间：<%=time.toString().substring(0,9) %></span>
				</h3>
